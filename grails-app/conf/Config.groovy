...
grails.plugins.springsecurity.userLookup.userDomainClassName = 'icanapp.User'
grails.plugins.springsecurity.userLookup.authorityJoinClassName = 'icanapp.UserRole'
grails.plugins.springsecurity.authority.className = 'icanapp.Role'
...
grails {
	mail {
	  host = "smtp.gmail.com"
	  port = 465
	  username = "tigroids@gmail.com"
	  password = "AppsFr0mTigras"
